	          ...
	          <div class="card center shadow-sm p-3 mb-5 bg-white rounded">
               <div class="card-body">
                  <p class="card-text" style="text-align: center">
                     <h2 style="text-align: center">Successfully Attended!</h2>
                      <p style="text-align: center">Your attendance will be updated once it is confirmed.</p>
                     <br><br>
                     <form action="attend.jsp" style="text-align: center">
