	          ...
	          <div class="card center shadow-sm p-3 mb-5 bg-white rounded">
               <div class="card-body">
                  <p class="card-text" style="text-align: center">
                     <h2 style="text-align: center">Successfully Created!</h2>
                      <p style="text-align: center">You can find your course listed in the View Details page.</p>
                     <br><br>
                     <form action="faculty.jsp" style="text-align: center">
                       <button type="submit" class="btn btn-primary" value = "back">Go to Details page</button>
                     </form>
              </div>
            </div>
