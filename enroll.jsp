              ...
              <p class="card-text">
                  ...
                  <form>
                        <div class="form-group">
                          ...
                          <input type="text" class="form-control" id="courseId" aria-describedby="emailHelp" placeholder="Enter Course Id">
                        </div>
                        <div class="form-row">
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <input type="text" class="form-control" id="slot" placeholder="Enter Slot">             
                            </div>
                        </div>
